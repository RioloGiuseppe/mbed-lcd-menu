...
{
  public:
    NokiaLcd(PinName din, PinName clk, PinName ce, PinName dc);
    ~NokiaLcd();
    void InitLcd();
    void ClearLcdMem();
    void ShutdownLcd();
    ...
    void DrawStringNegative(char *str);
...
const char FONT_6x6[576] = //should be 564 total char
    {
        ...
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, // FULL 96
};
#endif
